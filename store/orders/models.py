...
class ProductInOrder(models.Model):
    ...
    def save(self, *args, **kwargs):
        ...
        self.total_price = self.num * self.price_per_item

        super(ProductInOrder, self).save(*args, **kwargs)

    
def product_in_orer_post_save(sender, instance, created, **kwargs):
...
post_save.connect(product_in_orer_post_save, sender=ProductInOrder)